          ...
          >
            ...
            <div>
              <button
                ...
                className="w-full px-6 py-3 bg-amber-400 text-black font-semibold text-lg hover:text-black focus:outline-hidden hover:shadow-[10px_10px_1px_rgba(255,255,255,1)] transition-all duration-200 cursor-pointer"
              >
                SEND
              </button>
            </div>
