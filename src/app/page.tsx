...
const Home = () => {
  ...
  return (
    <ThemeContext.Provider value={{ theme, setTheme }}>
      <div
        className={
          "page-container px-14 w-screen h-screen selection:bg-amber-300 font-['Geist']"
        }
        id="page-wrapper"
      >
        <Header />
          ...
          >
            <div id={"col-2"}>
              ...
              <p className={"pt-5 text-2xl leading-relaxed  pr-44 px-14"}>
                ...
                Praesent imperdiet enim eget magna pretium tristique. In
                tincidunt mi nec enim gravida, ut dictum arcu tincidunt.
                Praesent eget pretium massa, et laoreet sem. Aliquam blandit
                imperdiet erat in finibus. Quisque iaculis libero nisl,
                elementum varius lectus finibus vitae. Mauris nec ligula mollis,
                pharetra tellus sed, ornare purus. Nam quis ex vitae nisi
                suscipit dictum et et lectus. Donec a tincidunt felis. Integer
                at pulvinar dolor. Pellentesque habitant morbi tristique
                senectus et netus et malesuada fames ac turpis egestas.
                Pellentesque tristique, diam id feugiat vestibulum, risus nisl
                maximus est, vel tincidunt risus ligula eget urna. Vivamus
                maximus, felis sed tincidunt lobortis, velit purus congue arcu,
                sit amet faucibus urna massa et odio. <br />
                <br />
                Integer eget elit elit. Nullam sed tellus nisl. Nullam vel
                ornare dolor. Fusce eu pharetra metus. Etiam vitae lorem elit.
                Aliquam nec consequat leo. Quisque ultricies leo a ipsum
                accumsan tempus. Nam non bibendum ante. Integer sit amet
                tincidunt metus. Praesent dignissim, enim eu euismod tincidunt,
                elit lacus rutrum libero, sit amet tincidunt ante nulla a felis.
                Vestibulum hendrerit urna lorem, nec aliquam dolor porta ut.
                Phasellus rutrum nisl eu libero tincidunt, id eleifend massa
                feugiat. In eu purus dictum nisi tincidunt laoreet nec vitae
                turpis. Mauris eu fringilla lectus, at feugiat mi. Praesent
                aliquam maximus libero, fringilla suscipit mauris cursus eu.
                Nulla tortor augue, rutrum condimentum tortor vitae,
                pellentesque congue risus. Cras ac arcu id lacus luctus
    ...
    <>
      ...
      <div id={"flex-box-container"} className={"flex flex-row pb-20"}>
        <p className={"text-2xl w-[30vw] leading-relaxed"}>
          ...
          Moon... We choose to go to the Moon in this decade and do the other x
        ...
        >
          ...
          <Image
            ...
            alt={"image4"}
            className={
              "col-start-2 row-start-1 row-span-1 col-span-1 prow-start-1 drop-shadow-2xl h-full object-cover object-center "
            }
          />
        </div>
      </div>
